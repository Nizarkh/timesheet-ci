...
public class EmployeService implements IEmployeService {
	...
	public Employe ajouterEmploye(Employe employe) {
		try {
			...
			l.error("Erreur d'ajout d'employée" + e);
		}
	...
	public Contrat ajouterContrat(Contrat contrat) {
		try {
			...
			l.error("Erreur d'ajout du contrat" + e);
		}
	...
	/*
	 * @Override public void affecterDepartementAEntreprise(int depId, int
	 * entrepriseId) {
	 * 
	 * Departement departement= departementRepository.findById((long)
	 * depId).get(); if(departement!=null){ Entreprise entreprise =
	 * entrepriseRepository.findById((long) entrepriseId).get();
	 * if(entreprise!=null){ departement.setEntreprise(entreprise);
	...
	public void mettreAjourEmailByEmployeId(String email, int employeId) {
		try {
			...
			l.error("Erreur de m.à.jour e-mail" + e);
		}
